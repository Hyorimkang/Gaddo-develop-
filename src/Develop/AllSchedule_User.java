...
public class AllSchedule_User extends JFrame {
	...
	void Image() {
		ImagePanel AllSchedule_User = new ImagePanel(new ImageIcon("E:\\\\java Project dev.ver\\\\Project\\\\Image Source\\\\AllSchedule_User.jpg").getImage());
		AllSchedule_User.setLocation(0, 0);
		setPreferredSize(AllSchedule_User.getDim());
		setSize(AllSchedule_User.getDim());
		getContentPane().add(AllSchedule_User);
	...
	void button() {
		...
		search.setBounds(12, 135, 106, 50);
		...
		//D-day 계산
		JButton D_day = new JButton();
		D_day.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		D_day.setBounds(12, 135, 106, 50);
		D_day.setIcon(new ImageIcon("E:\\\\java Project dev.ver\\\\Project\\\\Image Source\\\\D_day.jpg"));
		getContentPane().add(D_day);
				
		D_day.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				new SearchData();
				setVisible(false); // 창 안보이게 하기 
		...
		time.setBounds(12, 135, 106, 50);
		time.setIcon(new ImageIcon("E:\\\\java Project dev.ver\\\\Project\\\\Image Source\\\\time.jpg"));
